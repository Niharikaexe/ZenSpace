...
export const metadata: Metadata = {
  ...
  description:
    'Feeling burned out, anxious, or just off? Talk to a real therapist online. First 15-minute call is free. No waiting rooms, no judgment. ZenSpace — therapy for working Indians.',
  keywords: [
