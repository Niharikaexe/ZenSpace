...
export const metadata: Metadata = {
  ...
  description:
    'Feeling burned out, anxious, or just off? Talk to a real therapist online. Free intro chat before you pay. No waiting rooms, no judgment. MindCanopy — therapy for working Indians.',
  keywords: [
