...
// Shown while a therapist dashboard page loads. Mirrors TherapistNav's shell so
// the navbar appears to stay put — only the body below shows the spinner.
export default function TherapistDashboardLoading() {
  return (
    <div className="min-h-screen flex flex-col bg-[#FAFAFA]">
      {/* Static nav shell (mirrors TherapistNav) */}
