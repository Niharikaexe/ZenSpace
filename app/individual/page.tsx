...
import { Plus, Minus, Lock, MessageCircle, RefreshCw, Video } from "lucide-react"
  ...
  <section className="bg-white relative overflow-hidden min-h-[80vh] flex items-center">
    ...
    <div className="max-w-5xl mx-auto px-6 py-20 md:py-28 w-full relative z-10">
      ...
      >
        ...
        <h1
          className="text-4xl md:text-5xl lg:text-[3.4rem] font-black text-[#233551] leading-[1.1] tracking-tight"
        ...
        <div className="flex flex-wrap gap-4">
          <Link
            ...
            className="inline-flex items-center gap-2 bg-[#233551] text-white text-sm font-bold px-7 py-3.5 rounded-full hover:bg-[#2d4568] transition-all duration-200 shadow-lg shadow-[#233551]/20"
          >
            Start the assessment
          </Link>
        </div>

        <p className="text-xs text-[#233551]/35 font-medium">
    ...
    <div className="max-w-5xl mx-auto px-6 relative z-10">
      <div className="flex flex-col lg:flex-row gap-12 lg:gap-20 items-start">
        ...
        >
          ...
          <p className="mt-5 text-[#233551]/60 text-base leading-relaxed">
        ...
        >
          <div className="space-y-4">
            {groundedPoints.map((p, i) => (
              <div key={i} className="flex gap-4 items-start">
                <div className="flex-shrink-0 mt-1.5 w-1.5 h-1.5 rounded-full bg-[#E8926A]" />
          ...
          <div className="bg-white rounded-2xl px-7 py-6 border-l-4 border-[#7EC0B7]">
            <p className="text-[#233551] text-base leading-relaxed font-medium">
              Therapy isn&apos;t a last resort for when things break.
            </p>
            <p className="text-[#233551]/60 text-sm leading-relaxed mt-2">
              It&apos;s the practice of making sure they don&apos;t. A space where you can set the weight down and just exist.
            </p>
          </div>
        </motion.div>
      </div>
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
        {balanceTopics.map((t, i) => (
          <motion.div
            ...
            className="bg-[#FFF5F2] rounded-2xl p-6 border border-[#E8926A]/10"
          >
            <h3
              className="text-sm font-black text-[#233551] mb-2"
              style={{ fontFamily: "var(--font-lato)" }}
            >
              {t.label}
            </h3>
      ...
      <div className="grid md:grid-cols-3 gap-8">
        {steps.map((s, i) => (
          <motion.div
            ...
            className="bg-white rounded-3xl p-7 shadow-sm shadow-[#233551]/6 border border-slate-100"
          >
            <span
              className="text-4xl font-black text-[#E8926A]/30 mb-4 block"
              style={{ fontFamily: "var(--font-lato)" }}
            >
              {s.number}
            </span>
            <h3
              className="text-base font-black text-[#233551] mb-3"
              style={{ fontFamily: "var(--font-lato)" }}
            >
              {s.title}
            </h3>
...
const Pricing = () => (
  <section className="bg-[#233551] py-20 md:py-28 relative overflow-hidden">
    <div className="absolute top-12 left-16 w-2 h-2 rounded-full bg-[#7EC0B7] opacity-40" />
    <div className="absolute bottom-20 right-24 w-1.5 h-1.5 rounded-full bg-[#E8926A] opacity-50" />
    ...
    <div className="max-w-5xl mx-auto px-6 relative z-10">
      ...
      <div className="flex flex-col lg:flex-row gap-8 items-start justify-center">
        <motion.div
          ...
          className="bg-white rounded-3xl p-8 lg:w-72 flex-shrink-0"
        >
          <span className="inline-block bg-[#E0F4F1] text-[#3D8A80] text-xs font-bold uppercase tracking-wider px-3 py-1.5 rounded-full mb-5">
            Essentials
          </span>
          <div className="mb-2">
            <span
              className="text-4xl font-black text-[#233551]"
              style={{ fontFamily: "var(--font-lato)" }}
            >
              ₹2,999
            </span>
          ...
          <Link
            href="/questionnaire?type=individual"
            className="block text-center bg-[#233551] text-white text-sm font-bold py-3 rounded-full hover:bg-[#2d4568] transition-all"
          >
            Start the assessment
          </Link>
        </motion.div>
        ...
        <div className="flex-1 space-y-6">
          {features.map((f, i) => (
            ...
            >
              <div className="flex-shrink-0 w-11 h-11 rounded-2xl bg-[#7EC0B7]/20 flex items-center justify-center">
                <f.icon size={18} className="text-[#7EC0B7]" />
              </div>
              <div>
                <h3
  ...
  return (
    <section className="bg-white py-20 md:py-24">
      <div className="max-w-3xl mx-auto px-6">
        <motion.h2
          className="text-3xl md:text-4xl font-black text-[#233551] text-center mb-12"
          style={{ fontFamily: "var(--font-lato)" }}
            ...
            >
              <div
                className={`rounded-2xl border overflow-hidden transition-all duration-200 ${
                  open === i ? "border-[#7EC0B7]/40 bg-[#7EC0B7]/5" : "border-slate-100 bg-white"
                }`}
              >
                <button
                ...
                >
                  <span className={`text-base font-bold ${open === i ? "text-[#3D8A80]" : "text-[#233551]"}`} style={{ fontFamily: "var(--font-lato)" }}>
                    {f.q}
                  </span>
                  <span className={`flex-shrink-0 ml-4 w-7 h-7 rounded-full flex items-center justify-center ${open === i ? "bg-[#7EC0B7] text-white" : "bg-slate-100 text-[#233551]"}`}>
                    {open === i ? <Minus size={14} /> : <Plus size={14} />}
                  </span>
                </button>
                {open === i && (
                  <p className="px-6 pb-5 text-sm text-[#233551]/60 leading-relaxed">{f.a}</p>
                )}
              </div>
            </motion.div>
          ))}
        ...
        >
          ...
          <Link
            href="/questionnaire?type=individual"
            className="inline-flex items-center gap-2 bg-[#233551] text-white text-sm font-bold px-8 py-4 rounded-full hover:bg-[#2d4568] transition-all shadow-lg shadow-[#233551]/20"
          >
            Start the assessment
          </Link>
        </motion.div>
