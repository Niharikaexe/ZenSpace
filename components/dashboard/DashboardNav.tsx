...
export function DashboardNav({ userName, isMatched }: Props) {
          ...
          {isMatched ? (
            <>
              ...
              <nav className="hidden sm:flex items-center gap-1 mr-2">
                <Link
                  href="/dashboard/chat"
                  className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-sm text-[#233551]/60 hover:text-[#233551] hover:bg-slate-50 transition-colors"
                >
            ...
            <form action={signOut}>
              <button
                type="submit"
                className="text-sm font-medium text-[#233551]/50 hover:text-[#233551] transition-colors px-3 py-1.5 rounded-lg hover:bg-slate-50"
              >
                Logout
              </button>
            </form>
