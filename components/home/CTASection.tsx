      ...
      <div className="py-20 md:py-28">
        <div className="max-w-6xl mx-auto px-6">
          <div className="flex flex-col md:flex-row items-center gap-12 max-w-4xl mx-auto">
            <motion.div className="flex-1 space-y-6" initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.7 }}>
              <h2 className="text-3xl md:text-4xl font-black text-white leading-tight" style={{ fontFamily: 'var(--font-lato)' }}>You&apos;ve done the reading.<br />Now, start the practice.</h2>
              <p className="text-white/55 text-base leading-relaxed max-w-md">Take five minutes to tell us about your world. We&apos;ll help you find the right person to talk to.</p>
              <Link href="/questionnaire" className="inline-flex items-center gap-2 bg-white text-[#233551] text-sm font-bold px-7 py-3.5 rounded-full hover:bg-[#F0F8F7] transition-all duration-200 shadow-lg shadow-black/20">
                Start the assessment →
              </Link>
            </motion.div>
            <motion.div className="flex-shrink-0" initial={{ opacity: 0, scale: 0.85 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} transition={{ duration: 0.7, delay: 0.2 }}>
