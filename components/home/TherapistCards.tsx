      ...
      <div className="max-w-6xl mx-auto px-6 pt-24 md:pt-32 pb-16 relative z-10">
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16 mb-16">
          ...
          >
            ...
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-black text-white leading-tight" style={{ fontFamily: 'var(--font-lato)' }}>
              People we&apos;ve met<br />and trust.
            </h2>
            <p className="text-white/55 text-base leading-relaxed max-w-md">
              Finding someone to talk to shouldn&apos;t feel like a research project. We&apos;ve already had the initial conversations with every therapist on Zen Space to make sure they&apos;re the right fit for this environment.
            </p>
            ...
            <Link href="/questionnaire" className="inline-flex items-center gap-2 text-sm font-bold text-[#7EC0B7] border-2 border-[#7EC0B7]/40 px-6 py-3 rounded-full hover:border-[#7EC0B7] hover:bg-[#7EC0B7]/10 transition-all duration-200">
        ...
        <div className="flex justify-end gap-2 mb-6">
          <button onClick={() => scroll("left")} disabled={!canScrollLeft} className="w-9 h-9 rounded-full border border-white/20 flex items-center justify-center text-white/60 hover:text-white hover:border-white/50 disabled:opacity-25 disabled:cursor-not-allowed transition-all">
            <ChevronLeft size={16} />
          </button>
          <button onClick={() => scroll("right")} disabled={!canScrollRight} className="w-9 h-9 rounded-full border border-white/20 flex items-center justify-center text-white/60 hover:text-white hover:border-white/50 disabled:opacity-25 disabled:cursor-not-allowed transition-all">
              ...
              <div className="flex flex-col items-center text-center space-y-3.5">
                ...
                {t.available ? (
                  <span className="inline-flex items-center gap-1.5 text-xs font-semibold text-[#7EC0B7] bg-[#7EC0B7]/12 px-3 py-1 rounded-full">
                    <span className="w-1.5 h-1.5 rounded-full bg-[#7EC0B7] animate-pulse" />Available Now
                  </span>
                ) : (
