...
const steps = [
  {
    ...
    description:
      "A few questions to help us understand your rhythm. It takes five minutes and helps us find the right person for your specific needs.",
  },
  {
    number: "02",
    title: "Have a conversation",
    description:
      "Meet the therapist we've paired you with for a 15-minute introductory chat. It's a chance to see if the environment feels right before you commit to the practice.",
  },
  {
    number: "03",
    title: "Make it a habit",
    description:
      "Start your weekly conversations through video or messaging. It's your space, on your schedule. If you ever feel like you need a different perspective, you can find a new therapist whenever you like.",
  },
]
  ...
  return (
    <section id="how-it-works" className="bg-[#FFF5F2] py-20 md:py-28 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-6 relative z-10">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-black text-[#233551] leading-tight mb-4" style={{ fontFamily: 'var(--font-lato)' }}>
            From joining to your<br />first conversation.
          </h2>
        ...
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-16 items-start">
          ...
          >
            <div className="bg-white rounded-3xl p-8 shadow-xl shadow-[#233551]/8 border border-white relative overflow-hidden">
              ...
              <h3 className="text-xl font-black text-[#233551] leading-snug mb-4" style={{ fontFamily: 'var(--font-lato)' }}>
                Before you pay anything, you talk to them first.
              </h3>
              <p className="text-sm text-[#233551]/55 leading-relaxed mb-6">
                Every match starts with a free 15-minute call. If it doesn't feel right, you pick someone else. No invoice, no awkwardness.
              </p>
              <Link href="/questionnaire" className="inline-flex items-center gap-2 text-sm font-bold text-[#233551] border-2 border-[#233551]/20 px-5 py-2.5 rounded-full hover:border-[#233551]/50 hover:bg-[#233551]/4 transition-all duration-200">
