...
export function TreeOwl() {
  return (
    <>
      ...
      <style jsx global>{`
        .zs-cta-float-slow   { animation: zs-cta-float-slow 4s ease-in-out infinite; transform-box: fill-box; transform-origin: center; }
        .zs-cta-float-medium { animation: zs-cta-float-medium 3s ease-in-out infinite; transform-box: fill-box; transform-origin: center; }
        .zs-cta-float-fast   { animation: zs-cta-float-fast 2.5s ease-in-out infinite; transform-box: fill-box; transform-origin: center; }
        .zs-cta-pulse        { animation: zs-cta-pulse 2s ease-in-out infinite; }
        .zs-cta-leaf-fall    { animation: zs-cta-leaf-fall 6s ease-in infinite; transform-origin: center; }
