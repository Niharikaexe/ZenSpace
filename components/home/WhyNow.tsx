    ...
    <section className="bg-white py-20 md:py-28 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-6 relative z-10">
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-20 items-start">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-black text-[#233551] leading-tight" style={{ fontFamily: "var(--font-lato)" }}>
          ...
          >
            ...
            <div className="bg-[#FFF5F2] rounded-2xl px-7 py-6 border-l-4 border-[#E8926A]">
              <p className="text-[#233551] text-base leading-relaxed font-medium">Whatever you&apos;re carrying, it&apos;s enough.</p>
              <p className="text-[#233551]/60 text-sm leading-relaxed mt-2">Therapy isn&apos;t about being broken. It&apos;s about having a place to set the weight down.</p>
            </div>
          </motion.div>
        </div>
      </div>
